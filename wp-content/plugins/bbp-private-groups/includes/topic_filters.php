...
function private_groups_topics ($args='') {
		//we only need to filter topics if this forum has topic permssions set to 5 - Create/Edit/view OWN Topics, create/edit Replies to those topics and view any Replies to those topics
